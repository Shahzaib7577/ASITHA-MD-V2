...
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am alive now!! apko kia help chahiye!!*" : process.env.ALIVE_MSG,
...
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "yourvortex899@gmail.com" : process.env.SEEDER_GMAIL,
